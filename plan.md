...
> **历史文档说明（2026-07）**：以下为初始设计规划，保留作参考。其中 **清理中心、对比搜索、AI（对话/分类/摘要/批量）、场景工作台（Boards）、发现（Discover）、系统设置、概览、MCP、关于** 等功能已从代码库整体移除，现状以 README 与 `docs/openapi.yaml` 为准。 书签管理平台 — 完整设计文档
